...
trainNet[net_,dataset_,labeldataset_, batchsize_:8, maxtrainRounds_: 100]:=Module[{dir},
dir=SetDirectory[NotebookDirectory[]];
...
saveNeuralNet[dir_,net_]:=Export[dir,net] /; Head[net]=== NetGraph;


saveInputs[dir_,data_,labels_,opt:("data"|"validation")]:=Switch[opt,"data",
